...
class block_learning_style_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        $mform->addElement('selectyesno', 'config_showdescriptions', get_string('config_showdescriptions', 'block_learning_style'));
        $mform->setDefault('config_showdescriptions', 0); 
        $mform->setType('config_showdescriptions', PARAM_BOOL);
        $mform->addHelpButton('config_showdescriptions', 'config_showdescriptions', 'block_learning_style');
    }
}
