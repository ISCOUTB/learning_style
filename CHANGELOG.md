...
- Se mantiene el titulo "Exploración de Estilos de Aprendizaje" en todas las vistas del bloque.
...
- Consistencia con los otros bloques (chaside, personality_test y tmms_24).
- Seguridad mejorada.
